...
<body class="bg-gray-100 p-6">
  ...
  <div class="max-w-xl mx-auto bg-white p-6 rounded-xl shadow">
    ...
    <div class="flex flex-wrap gap-3">
      <a href="edit-user.php?id=<?php echo $id; ?>" class="bg-amber-500 hover:bg-amber-600 text-white px-4 py-2 rounded-lg inline-block">Edit User</a>
      <a href="delete-user.php?id=<?php echo $id; ?>" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg inline-block" onclick="return confirm('Are you sure you want to delete this user?')">Delete User</a>
