...
const ProductCard = ({ product }: { product: IProduct }) => {
  ...
  return (
    <Card onClick={goToDetails} className="mx-auto flex w-full max-w-sm flex-col overflow-hidden transition-all duration-200 hover:shadow-md cursor-pointer">
      ...
      <CardFooter className="pt-0">
        <Button onClick={(e) => e.stopPropagation()} className="w-full py-5 transition-transform active:scale-[0.98]">
          Add to Cart
        </Button>
      </CardFooter>
    </Card>
