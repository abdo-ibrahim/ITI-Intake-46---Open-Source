      ...
      {isLoading ? (
        ...
        <>
          <p className="text-gray-500 mb-4">
            Showing results for: <span className="font-semibold">{categoryQuery || "All Products"}</span>
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            {filteredProducts.length === 0 && <p className="col-span-full text-center py-10 text-gray-500">No products found.</p>}
          </div>
        </>
      )}
    </div>
