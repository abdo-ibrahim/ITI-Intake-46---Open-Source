                    ...
                    @foreach ($todos as $todo)
                        <tr class="hover:bg-slate-50 transition-colors group">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center space-x-2 mt-1">
                                            <p class="text-[10px] text-slate-400">Created At:
                                                {{ \Carbon\Carbon::parse($todo->created_at)->format('Y-m-d') }}</p>
                                            <span class="text-slate-200">|</span>
                                            <p
                                                class="text-[10px] font-mono text-indigo-400 bg-indigo-50/50 px-1.5 py-0.5 rounded">
                                                {{ $todo->slug }}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <td class="px-6 py-5">
                                ...
                                <div class="flex items-center {{ $currentStatus['color'] }} text-sm font-medium">
                                    ...
                                    @else
                                        <div class="w-2 h-2 rounded-full {{ $currentStatus['dot'] }} mr-2"></div>
                                    @endif
                                    {{ $currentStatus['label'] }}
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-5 text-right">
                                <div class="flex justify-end space-x-2">
                                    ...
                                    <button type="button"
                                        onclick="openDeleteModal('{{ route('todos.destroy', $todo) }}', '{{ $todo->title }}')"
