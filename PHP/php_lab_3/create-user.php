...
<body class="bg-[#f3f3f3]">
  ...
  <div class="max-w-xl mx-auto bg-white p-6 rounded-xl shadow">
    ...
    <form action="save-users.php" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow-md mt-4">
      <label for="name">Full Name:</label>
      <input type="text" id="name" name="name" required class="border border-gray-300 rounded py-2 px-4"><br><br>

      <label for="email">Email:</label>
      <input type="email" id="email" name="email" required class="border border-gray-300 rounded py-2 px-4"><br><br>
      ...
      <input type="file" id="profile-image" name="profile-image" required class="border border-gray-300 rounded py-2 px-4"><br><br>
