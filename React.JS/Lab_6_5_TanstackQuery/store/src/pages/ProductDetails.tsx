...
import { useProductDetails } from "@/hooks/useProdcuts";
...
const ProductDetails = () => {
  ...
  if (error || !product) {
    return <div className="max-w-4xl mx-auto p-8 text-center text-red-600">{error instanceof Error ? error.message : "Product not found."}</div>;
  }
